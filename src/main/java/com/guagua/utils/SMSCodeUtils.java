...
public class SMSCodeUtils {
    ...
    public static String SendAlicomMsgDemo(String number) {
        String code;
        //设置超时时间-可自行调整
        ...
        //替换成你的AK
        final String accessKeyId = "LTAIi6w57Xijc0iU";//你的accessKeyId,参考本文档步骤2
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("云客服众包平台");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_126865647");
